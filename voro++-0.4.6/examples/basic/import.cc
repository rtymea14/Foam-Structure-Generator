...
//const double x_min=-0.3,x_max=0.3;
//const double y_min=-0.3,y_max=0.3;
//const double z_min=-0.3,z_max=0.3;
...
//	con.import("rand14adj.csv");
//
//	// Save the Voronoi network of all the particles to text files
//	// in gnuplot and POV-Ray formats
//	con.draw_cells_gnuplot("rand14.gnu");
//	con.draw_cells_pov("rand14_v.pov");
//
//	// Output the particles in POV-Ray format
//	con.draw_particles_pov("rand14_p.pov");
//	con.draw_domain_pov("rand14domain.pov");
	...
	con.draw_domain_pov("importdomain.pov");
}
